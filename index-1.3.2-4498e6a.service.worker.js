...
/** @type {string} */
const CACHE_VERSION = '1785506882|3721480';
/** @type {string} */
const CACHE_PREFIX = 'Runes-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'index-1.3.2-4498e6a.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["index-1.3.2-4498e6a.html","index-1.3.2-4498e6a.js","index-1.3.2-4498e6a.offline.html","index-1.3.2-4498e6a.icon.png","index-1.3.2-4498e6a.apple-touch-icon.png","index-1.3.2-4498e6a.audio.worklet.js","index-1.3.2-4498e6a.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["index-1.3.2-4498e6a.wasm","index-1.3.2-4498e6a.pck"];
